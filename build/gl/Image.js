...
export class GLImage {
    constructor(imageElement) {
        ...
        config.compute.gl.texParameteri(config.compute.gl.TEXTURE_2D, config.compute.gl.TEXTURE_MIN_FILTER, config.compute.gl.NEAREST);
        config.compute.gl.texParameteri(config.compute.gl.TEXTURE_2D, config.compute.gl.TEXTURE_MAG_FILTER, config.compute.gl.NEAREST);
